...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-100 dark:bg-slate-950 text-slate-600 dark:text-slate-400 border-t border-slate-200 dark:border-slate-900 mt-auto transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Info */}
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2 text-slate-900 dark:text-white font-bold text-xl">
            ...
            <div className="flex space-x-4 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-slate-500 hover:text-teal-600 dark:hover:text-teal-400 transition-colors"
                aria-label="GitHub"
              >
          ...
          {/* Discover Links */}
          <div>
            <h3 className="text-slate-900 dark:text-white font-semibold text-sm uppercase tracking-wider mb-4">
              Discover
            </h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/itineraries" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors">
                  Explore Blueprints
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/help" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors">
                  Help Center / FAQs
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:support@auratravel.com" className="hover:text-teal-600 dark:hover:text-teal-400">
        ...
        <div className="border-t border-slate-200 dark:border-slate-900 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">

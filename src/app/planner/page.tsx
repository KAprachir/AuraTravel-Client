      ...
      <main className="flex-grow max-w-6xl mx-auto px-4 py-8 w-full space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-400 mt-1">Manage listed itineraries, sales revenue, payment transactions, and listings</p>
          </div>
          <Link
        ...
        {successMessage && (
          <div className="bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 p-3 rounded-lg flex items-center space-x-2 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-slate-900 border-slate-800 text-white">
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-sm font-medium text-slate-400">Total Sales Revenue</CardTitle>
        ...
        {activeTab === "sales" ? (
                  ...
                  <Table>
                    <TableHeader className="bg-slate-950">
                      <TableRow className="border-slate-800">
                        <TableHead className="text-slate-400">Itinerary Product</TableHead>
                        <TableHead className="text-slate-400">Trip Start Date</TableHead>
                        <TableHead className="text-slate-400">Travelers</TableHead>
                        <TableHead className="text-slate-400">Payment Status</TableHead>
                        <TableHead className="text-slate-400 text-right">Total Paid</TableHead>
                        <TableHead className="text-slate-400 text-center w-[100px]">Action</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {bookings.map((b) => (
          ...
          <Card className="bg-slate-900 border-slate-800 text-white overflow-hidden shadow-xl">
            <CardHeader className="bg-slate-950/20 border-b border-slate-800 pb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <Table>
                  <TableHeader className="bg-slate-950">
                    <TableRow className="border-slate-800">
                      ...
                      <TableHead className="text-slate-400 text-center w-[140px]">Actions</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {myItineraries.map((it) => (
                      <TableRow key={it._id} className="border-slate-850 hover:bg-slate-850/20">
                        ...
                        <TableCell className="font-semibold text-white max-w-[220px] truncate">
                          <div>
                        ...
                        <TableCell className="text-center">
                          <div className="flex items-center justify-center space-x-1.5">
                            <Link
                              ...
                              className="h-8 w-8 text-teal-400 hover:text-teal-300 hover:bg-slate-800 rounded flex items-center justify-center cursor-pointer"
                              title="View Listing"
                            >
                            ...
                            <Button
                              ...
                              className="h-8 w-8 text-slate-400 hover:text-amber-400 hover:bg-slate-800"
                              title="Edit Listing"
                            >
              ...
              <div className="space-y-3 max-h-[70vh] overflow-y-auto pr-1">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 rounded p-2 text-sm text-white focus:outline-none focus:border-teal-500"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-400">Cost ($)</label>
                    <input
                      type="number"
                      value={editCost}
                ...
                <div className="flex items-center space-x-2 pt-2">
                  <input
                    ...
                    className="h-4 w-4 rounded border-slate-800 bg-slate-950 text-teal-600"
                  />
                  <label htmlFor="editIsPublic" className="text-xs text-slate-300 font-medium">

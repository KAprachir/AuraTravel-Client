      ...
      <main className="flex-grow max-w-5xl mx-auto px-4 py-12 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            <Card className="bg-slate-900 border-slate-800 text-white p-6 shadow-lg h-full flex flex-col justify-between">
              <div>
                <h3 className="font-bold text-white text-lg border-b border-slate-800 pb-3 mb-6">
                  Get in Touch
                </h3>
                <ul className="space-y-6 text-sm">
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <span className="text-slate-400 text-xs">100 Travel Way, Sky Tower, CA</span>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    <Phone className="h-5 w-5 text-teal-400 shrink-0" />
                    <div>
                      <span className="font-semibold block text-white">Phone Support</span>
                      <span className="text-slate-400 text-xs">+1 (555) 123-4567</span>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
              ...
              <div className="text-xs text-slate-500 pt-6 border-t border-slate-800/40 mt-6">
          ...
          <div className="md:col-span-2">
            <Card className="bg-slate-900 border-slate-800 text-white shadow-2xl">
              ...
              <CardContent>
                {success ? (
                  <div className="bg-teal-500/15 border border-teal-500/30 text-teal-300 p-6 rounded-lg text-center space-y-4">
                    <CheckCircle2 className="h-12 w-12 text-teal-400 mx-auto animate-bounce" />
                    ...
                    <Button
                      ...
                      className="bg-teal-500 hover:bg-teal-600 text-slate-950 font-bold text-xs"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1">
                      <label className="text-xs text-slate-400 font-semibold block">Subject</label>
                      <Input
                        value={subject}

    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      <main className="flex-grow max-w-5xl mx-auto px-4 py-12 w-full">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          <h1 className="text-4xl font-extrabold text-white tracking-tight">About AuraTravel</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-16">
          ...
          <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl">
        ...
        {/* Tech Stack Pillars */}
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white text-center mb-10">Architectural Pillars</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-slate-900 border-slate-800 text-white p-6 shadow-lg">
              <CardHeader className="p-0 mb-4 flex items-center space-x-3">
                <div className="h-10 w-10 bg-teal-500/10 rounded-lg flex items-center justify-center text-teal-400 shrink-0">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-lg">
          <h2 className="text-xl font-bold text-white mb-6 text-center">AI Agent Workflow Pipeline</h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-xs text-center text-slate-300">
            <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 w-44 space-y-2">
              <div className="font-bold text-teal-400 uppercase text-[10px]">Data Ingestion</div>
              <p className="text-[11px] text-slate-400">PDFs, Images, Receipts or Chat queries are received.</p>
            </div>
            <div className="text-teal-500 font-bold shrink-0">➔</div>
            <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 w-44 space-y-2">
              <div className="font-bold text-teal-400 uppercase text-[10px]">Context Gathering</div>
              <p className="text-[11px] text-slate-400">Database matches active user itineraries & expense records.</p>
            </div>
            <div className="text-teal-500 font-bold shrink-0">➔</div>
            <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 w-44 space-y-2">
              <div className="font-bold text-teal-400 uppercase text-[10px]">Gemini 1.5 Inference</div>
              <p className="text-[11px] text-slate-400">Prompt injection translates user data into answers or JSON.</p>
            </div>
            <div className="text-teal-500 font-bold shrink-0">➔</div>
            <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 w-44 space-y-2">
              <div className="font-bold text-teal-400 uppercase text-[10px]">Verification & UI</div>
              <p className="text-[11px] text-slate-400">User reviews editable values; charts update in real-time.</p>
            </div>
          </div>
        </div>
      </main>

    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white flex flex-col justify-center items-center px-4 relative overflow-hidden transition-colors duration-200">
      ...
      <Card className="w-full max-w-md bg-white/90 dark:bg-slate-900/80 border-slate-200 dark:border-slate-800 backdrop-blur-md text-slate-900 dark:text-white z-10 shadow-2xl">
        <CardHeader className="space-y-2 pb-2">
          <CardTitle className="text-2xl text-center font-bold tracking-tight text-slate-900 dark:text-white" style={{fontFamily: 'var(--font-jakarta)'}}>Create an Account</CardTitle>
        ...
        <CardContent>
          ...
          <Button
            ...
            className="w-full border border-slate-300 dark:border-slate-600 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-900 dark:text-white rounded-xl transition-all duration-200 font-medium text-sm cursor-pointer"
          >
